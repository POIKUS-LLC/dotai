...
import { Home, Info, MessageCircle, Settings, Star } from "lucide-react"
...
export default function DemoPage() {
  return (
    <div className="min-h-[200vh]">
      <PKSNavbar>
        <PKSNavbarBrand>
          <span className="text-xl font-bold">Demo Inc.</span>
        </PKSNavbarBrand>
        <PKSNavbarContent>
          <PKSNavbarItems>
            <PKSNavbarItem icon={<Home />} label="Home" href="#" />
            <PKSNavbarItem
              icon={<MessageCircle />}
              label="Features"
              href="#features"
            />
            <PKSNavbarItem icon={<Star />} label="Reviews" href="#reviews" />
            <PKSNavbarItem icon={<Info />} label="Pricing" href="#pricing" />
            <PKSNavbarSeparator />
            <PKSNavbarItem
              icon={<Settings />}
              label="Settings"
