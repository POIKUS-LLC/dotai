...
export function AIFolderCard({ folder, onPreviewClick }: AIFolderCardProps) {
  return (
    <div className="relative group rounded-2xl hover:scale-105 transition-all duration-300 mb-2 max-w-[550px]">
      <Card className="relative rounded-2xl bg-card">
        <CardHeader>
          ...
          <div className="flex gap-2 pt-2">
            ...
            {folder.language?.map((language) => <Badge>{language}</Badge>)}
          </div>
        </CardHeader>
        <CardBody>
